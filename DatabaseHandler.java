...
public class DatabaseHandler extends config  {
    ...
    public void signUpUser(User user){
        String insert = " INSERT INTO "+ Const.User_table +"(" + Const.User_FIRST_NAME+"," +
                Const.User_LAST_NAME+"," + Const.User_username + ","+ Const.User_PASSWORD +"," +Const.User_LOCATION+","
...
// insert tasks to the database
    public void insertTask(Task task) {
        ...
        String insert = " INSERT INTO "+ Const.Task_table +"(" + Const.User_ID+ ","+Const.TASK_DATE+","+
